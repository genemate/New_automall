...
export default function LocationSelection() {
  const [location, setLocation] = useState("Tanlangan viloyat");
  return (
    <Menu as="div" className="w-full h-full flex xl:flex-row" backdrop="blur">
      <Dropdown >
        <div className="relative flex-1">
          {/*btn*/}
          <Menu.Button className="dropdown-btn w-full h-full flex flex-col justify-center items-center xl:items-start xl:pl-8">
            <div className="w-full h-16 xl:h-14 flex justify-center xl:justify-start xl:border-r xl:border-black/10">
